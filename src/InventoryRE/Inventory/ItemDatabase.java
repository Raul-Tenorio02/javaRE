...
public final class ItemDatabase extends Item {
    ...
    public static final Weapon HK_VP70_BURST = new Weapon("H&K VP70 Burst", "\"VP70 with a stock holster. Capable of firing three round auto bursts.\"", ItemType.SPECIAL, WeaponType.HANDGUN , 18, 18, FireType.BURST);
    ...
    public static final Weapon FLAMETHROWER = new Weapon("Flamethrower", "\"Chemical fuel flamethrower made by Umbrella Inc. The fuel is fed from a small cartridge.\"", ItemType.WEAPON, WeaponType.FLAMETHROWER, 100, 100);
